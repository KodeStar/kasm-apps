      ...
      <div className='flex flex-col lg:flex-row w-full my-20 max-w-6xl text-sm rounded-xl overflow-hidden mx-auto'>
        <div className='w-full lg:w-1/2 p-16 bg-slate-300'>
          ...
          <div className='flex flex-col'>
            ...
            <input name="friendly_name" onChange={handleChange} className='mb-2 p-2 rounded-lg bg-white/30 border border-solid border-slate-600/60' />
            <p className='mb-6 opacity-70'>This is the name that will show for users</p>
            <label className='mb-2 font-medium'>Description</label>
            <input name="description" onChange={handleChange} className='mb-2 p-2 rounded-lg bg-white/30 border border-solid border-slate-600/60' />
            ...
            <input name="name" onChange={handleChange} className='mb-2 p-2 rounded-lg bg-white/30 border border-solid border-slate-600/60' />
            ...
            <input type="file" name="icon" onChange={handleChange} className='mb-2 p-2 rounded-lg bg-white/30 border border-solid border-slate-600/60' />
        ...
        <div className='w-full lg:w-1/2 p-16 bg-slate-100'>
          <pre className='mb-8 overflow-y-auto'>{JSON.stringify(application, null, 2)}</pre>
